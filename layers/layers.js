...
var features_NorthumberlandNamedStones_2 = format_NorthumberlandNamedStones_2.readFeatures(json_NorthumberlandNamedStones_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NorthumberlandNamedStones_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NorthumberlandNamedStones_2.addFeatures(features_NorthumberlandNamedStones_2);
var lyr_NorthumberlandNamedStones_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NorthumberlandNamedStones_2, 
                style: style_NorthumberlandNamedStones_2,
                popuplayertitle: 'Northumberland Named Stones',
                interactive: true,
                title: '<img src="styles/legend/NorthumberlandNamedStones_2.png" /> Northumberland Named Stones'
            });
...
lyr_ThunderforestLandscape_0.setVisible(true);lyr_Walks_1.setVisible(true);lyr_NorthumberlandNamedStones_2.setVisible(true);lyr_POI_3.setVisible(true);
var layersList = [lyr_ThunderforestLandscape_0,lyr_Walks_1,lyr_NorthumberlandNamedStones_2,lyr_POI_3];
lyr_Walks_1.set('fieldAliases', {'fid': 'fid', 'FileName': 'Walk Name', 'Length': 'Length (km)', 'Notes': 'Notes', 'link': 'link', });
lyr_NorthumberlandNamedStones_2.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'description': 'description', });
lyr_POI_3.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'Description': 'Description', 'Type': 'Type', });
lyr_Walks_1.set('fieldImages', {'fid': 'TextEdit', 'FileName': 'TextEdit', 'Length': 'TextEdit', 'Notes': 'TextEdit', 'link': 'TextEdit', });
lyr_NorthumberlandNamedStones_2.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'description': 'TextEdit', });
lyr_POI_3.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'Description': 'TextEdit', 'Type': 'TextEdit', });
...
lyr_NorthumberlandNamedStones_2.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - always visible', 'description': 'inline label - visible with data', });
lyr_POI_3.set('fieldLabels', {'fid': 'no label', 'Name': 'no label', 'Description': 'no label', 'Type': 'no label', });
