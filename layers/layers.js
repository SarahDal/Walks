...
lyr_Walks_2.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'FileName': 'no label', 'Length': 'no label', 'link': 'no label', 'Date Walked': 'no label', 'Notes': 'no label', 'name': 'no label', });
lyr_POI_3.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'Name': 'no label', 'Type': 'no label', 'Link': 'no label', 'Description': 'no label', });
lyr_NorthumberlandNamedStones_4.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'Name': 'no label', 'description': 'no label', 'Image': 'no label', 'alias': 'no label', });
