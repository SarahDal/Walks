...
lyr_OpenStreetMap_0.setVisible(true);lyr_BingAerial_1.setVisible(false);lyr_ThunderforestLandscape_2.setVisible(true);lyr_NorthumberlandNamedStones_3.setVisible(false);lyr_Walks_4.setVisible(true);lyr_POI_5.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_BingAerial_1,lyr_ThunderforestLandscape_2,lyr_NorthumberlandNamedStones_3,lyr_Walks_4,lyr_POI_5];
