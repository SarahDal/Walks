...
var format_NorthumberlandNamedStones_1 = new ol.format.GeoJSON();
var features_NorthumberlandNamedStones_1 = format_NorthumberlandNamedStones_1.readFeatures(json_NorthumberlandNamedStones_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NorthumberlandNamedStones_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NorthumberlandNamedStones_1.addFeatures(features_NorthumberlandNamedStones_1);
var lyr_NorthumberlandNamedStones_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NorthumberlandNamedStones_1, 
                style: style_NorthumberlandNamedStones_1,
                popuplayertitle: 'Northumberland Named Stones',
                interactive: true,
                title: '<img src="styles/legend/NorthumberlandNamedStones_1.png" /> Northumberland Named Stones'
            });
...
lyr_ThunderforestLandscape_0.setVisible(true);lyr_NorthumberlandNamedStones_1.setVisible(false);lyr_Walks_2.setVisible(true);lyr_POI_3.setVisible(true);
var layersList = [lyr_ThunderforestLandscape_0,lyr_NorthumberlandNamedStones_1,lyr_Walks_2,lyr_POI_3];
lyr_NorthumberlandNamedStones_1.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'description': 'description', 'Image': 'Image', 'alias': 'alias', });
...
lyr_NorthumberlandNamedStones_1.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'description': 'TextEdit', 'Image': 'ExternalResource', 'alias': 'TextEdit', });
...
lyr_NorthumberlandNamedStones_1.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - always visible', 'description': 'inline label - visible with data', 'Image': 'no label', 'alias': 'no label', });
