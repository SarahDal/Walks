...
lyr_OpenStreetMap_0.setVisible(true);lyr_ThunderforestLandscape_1.setVisible(true);lyr_NorthumberlandNamedStones_2.setVisible(false);lyr_Walks_3.setVisible(true);lyr_POI_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_ThunderforestLandscape_1,lyr_NorthumberlandNamedStones_2,lyr_Walks_3,lyr_POI_4];
...
lyr_NorthumberlandNamedStones_2.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'description': 'TextEdit', 'Image': 'ExternalResource', 'alias': 'TextEdit', });
...
lyr_NorthumberlandNamedStones_2.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - always visible', 'description': 'inline label - visible with data', 'Image': 'no label', 'alias': 'no label', });
